...
#ifndef OGONEK_ENCODINGS_ISO_8859_16_HPP
...
namespace ogonek {
    struct OGONEK_PUBLIC iso_8859_16_codepage {
        static OGONEK_PUBLIC code_point to_unicode[256];
        static OGONEK_PUBLIC detail::simple_byte_mapping from_unicode[256];
    };

    using iso_8859_16 = detail::simple_byte_mapping_encoding<iso_8859_16_codepage>;

    CONCEPT_ASSERT(EncodingForm<iso_8859_16>());
} // namespace ogonek

#endif // OGONEK_ISO_8859_16_HPP
