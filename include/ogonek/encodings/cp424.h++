...
#ifndef OGONEK_ENCODINGS_CP424_HPP
#define OGONEK_ENCODINGS_CP424_HPP
...
namespace ogonek {
    struct OGONEK_PUBLIC cp424_codepage {
        static OGONEK_PUBLIC code_point to_unicode[256];
        static OGONEK_PUBLIC detail::simple_byte_mapping from_unicode[218];
    };

    using cp424 = detail::simple_byte_mapping_encoding<cp424_codepage>;

    CONCEPT_ASSERT(EncodingForm<cp424>());
} // namespace ogonek
