...
#ifndef OGONEK_ENCODINGS_MAC_DINGBATS_HPP
#define OGONEK_ENCODINGS_MAC_DINGBATS_HPP
...
namespace ogonek {
    struct OGONEK_PUBLIC mac_dingbats_codepage {
        static OGONEK_PUBLIC code_point to_unicode[256];
        static OGONEK_PUBLIC detail::simple_byte_mapping from_unicode[202];
    };

    using mac_dingbats = detail::simple_byte_mapping_encoding<mac_dingbats_codepage>;

    CONCEPT_ASSERT(EncodingForm<mac_dingbats>());
} // namespace ogonek
