...
namespace ogonek {
    struct OGONEK_PUBLIC mac_cyrillic_codepage {
        static OGONEK_PUBLIC code_point to_unicode[256];
        static OGONEK_PUBLIC detail::simple_byte_mapping from_unicode[223];
    };

    using mac_cyrillic = detail::simple_byte_mapping_encoding<mac_cyrillic_codepage>;

    CONCEPT_ASSERT(EncodingForm<mac_cyrillic>());
} // namespace ogonek

#endif // OGONEK_MAC_CYRILLIC_HPP
